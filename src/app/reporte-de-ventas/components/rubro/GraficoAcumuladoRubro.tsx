...
import { DatoRubroAcumulado } from './types';

interface GraficoAcumuladoRubroProps {
  data: DatoRubroAcumulado[];
...
export const GraficoAcumuladoRubro: React.FC<GraficoAcumuladoRubroProps> = ({
  data,
  activeMetric,
  distanciaEtiquetas,
  formatCurrency,
  ...
  const CustomTooltip = ({
    ...
    active?: boolean;
    payload?: Array<{ payload?: DatoRubroAcumulado; value: number }>;
  }) => {
  ...
  return (
    <ResponsiveContainer width="100%" height={400}>
      <PieChart>
        <defs>
          <filter id="shadow3DRubro" x="-10%" y="-10%" width="120%" height="130%">
        ...
        <Pie
          ...
          label={(props) => {
            ...
            const valorFormateado =
              activeMetric === 'importe' ? formatCurrency(value) : formatQuantity(value);
