...
export function ConfigStep() {
  const { fichadasFile, fichadasColumnas, fichadasPreviewData, config, setStep, setMapeo, setDefaultConfig, recomputarEmpleados, normalizarEventos } = useAsistenciasStore();
